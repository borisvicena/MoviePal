  ...
  return (
    <>
      ...
      <header className="w-full my-4 px-4 md:pt-4 select-none">
        <div className="navbar justify-between bg-base-200 text-base-content rounded-box w-full max-w-2xl mx-auto">
          <div className="flex-none">
            <button className="btn btn-square btn-ghost" onClick={handleReload}>
              <img src={`icon.png`} alt={`Movie Pal`} className="w-10 h-10 rounded-full" />
            </button>
          </div>
